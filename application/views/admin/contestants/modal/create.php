<div class="modal-dialog">
    <div class="modal-content">
		...
		<div class="tab-content">
			...
			<form id="fileupload" action="<?php echo base_url("admin/competitions/" . $segment->competition_id . "/segments/" . $segment->id . "/contestants/upload"); ?>" method="post" enctype="multipart/form-data">
