...
class Contestants extends PT_Controller {
	...
	if($this->input->is_ajax_request())
	{
	    ...
	    $data = array("modal" => $this->load->view("administrator/contestants/modal/create", array("segment" => $segment), TRUE));
	...
	else
	{
	    ...
	    $this->load->view("administrator/segments/partial/view", array("competition" => $competition, "segment" => $competition->segment($segment_id)));
	    
	    $this->load->view("template/footer", array(
		    "modal" => $this->load->view("administrator/contestants/modal/create", array("segment" => $competition->segment($segment_id)), TRUE),
		    "scripts" => array(
			"tiara/admin/judges"
		    )
		)
	...
	$data = array(
	    "partial" => $this->load->view("administrator/contestants/partial/index", array("segment" => $segment_contestant->segment()), TRUE)
	);
