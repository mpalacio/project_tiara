...
class Criterias extends PT_Controller {
	...
	{
	    $data = array(
		"modal" => $this->load->view("administrator/criterias/modal/edit", array("segment" => $segment, "criteria" => $segment->criteria($id)), TRUE)
	    );
	...
	$data = array(
	    "partial" => $this->load->view("administrator/criterias/partial/index", array("segment" => $criteria->segment()), TRUE)
	);
